...
\todo[inline]{Talk about this template with your supervisor: Should you add a declaration for the use of AI? Currently no official AI-declaration is given. You can find one in the Issues of the Github repository.}
